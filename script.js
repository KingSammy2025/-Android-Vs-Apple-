...
// Containers are empty <p>, <h1>, <divs> elements.
...
function changeToApple() {
  ...
  document.getElementById("apple").classList.add("blueborder");

  // Remove the class 'active' from the Android button.
  document.getElementById("android").classList.remove("blueborder");
}
